...
def request_access_kb():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("📩 Request Access (Auto)", callback_data="request_access")],
        [InlineKeyboardButton("💬 Owner se Direct Baat Karo", url=f"https://t.me/{OWNER_USERNAME.lstrip('@')}")],
        [InlineKeyboardButton("📊 My Account", callback_data="my_account")],
    ])
